...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    public class BackendClient : MonoBehaviour
    {
        ...
        // [SerializeField] private string m_baseUrl = "http://10.193.0.17:8000";      // ECEB IllinoisNet (old)
        [SerializeField] private string m_baseUrl = "http://172.16.123.93:8000";     // ECEB IllinoisNet (current)
